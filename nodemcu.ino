...
const char* ssid1     = "duino-wifi";        //<-- ใส่ชือ Wifi หลัก ตรงนี
const char* password1 = "123456789o";    //<-- ใส่รหัส Wifi หลัก ตรงนี

const char* ssid2     = "duino-wifi";        //<-- ใส่ชือ Wifi หลัก ตรงนี
...
String AcctName       = "yentrexs";  //<-- ใส่ชือ User Name ตรงนี
String BrdNm          = "MCU-xxx"; //<-- ใส่ชือ RigName ตรงนี
...
const String FirmwareVer={"2.2"}; // Last of Version
#define URL_fw_Version "/yentrexs/nodemcu/master/fw_mcucheck.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/yentrexs/nodemcu/master/fw.bin"
