...
String BrdNm          = "ESP01-xxx"; //<-- ใส่ชือ RigName ตรงนี
...
#define URL_fw_Version "/yentrexs/esp01/main/fw_check.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/yentrexs/esp01/main/fw.bin"
